...
def build_model():
    ...
    water_cell = openmc.Cell(region=+clad_or, fill=borated_water, name="borated water")
    ...
    pin_bbox = openmc.model.RectangularPrism(
        specs.pitch, specs.pitch, boundary_type="reflective"
    )  # bounding box for pincell
    ...
    model.geometry = openmc.Geometry([model_cell])
